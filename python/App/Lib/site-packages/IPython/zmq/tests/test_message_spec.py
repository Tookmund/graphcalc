...
def test_user_variables():
    ...
    nt.assert_equals(user_variables, {'x' : '1'})
...
def test_user_expressions():
    ...
    nt.assert_equals(user_expressions, {'foo' : '2'})
...
def test_stream():
    ...
    yield nt.assert_equals(content['name'], 'stdout')
    yield nt.assert_equals(content['data'], 'hi\n')
...
def test_display_data():
    ...
    yield nt.assert_equals(data['text/plain'], '1')
