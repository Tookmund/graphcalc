...
def publish_pretty(data, metadata=None):
    ...
    publish_display_data(
        'IPython.core.displaypub.publish_pretty',
        {'text/plain':data},
        metadata=metadata
    )
...
def publish_html(data, metadata=None):
    ...
    """
    publish_display_data(
        'IPython.core.displaypub.publish_html',
        {'text/html':data},
        metadata=metadata
    )
...
def publish_latex(data, metadata=None):
    ...
    """
    publish_display_data(
        'IPython.core.displaypub.publish_latex',
        {'text/latex':data},
        metadata=metadata
    )
...
def publish_png(data, metadata=None):
    ...
    """
    publish_display_data(
        'IPython.core.displaypub.publish_png',
        {'image/png':data},
        metadata=metadata
    )
...
def publish_jpeg(data, metadata=None):
    ...
    """
    publish_display_data(
        'IPython.core.displaypub.publish_jpeg',
        {'image/jpeg':data},
        metadata=metadata
    )
...
def publish_svg(data, metadata=None):
    ...
    """
    publish_display_data(
        'IPython.core.displaypub.publish_svg',
        {'image/svg+xml':data},
        metadata=metadata
    )
...
def publish_json(data, metadata=None):
    ...
    """
    publish_display_data(
        'IPython.core.displaypub.publish_json',
...
def publish_javascript(data, metadata=None):
    ...
    """
    publish_display_data(
        'IPython.core.displaypub.publish_javascript',
