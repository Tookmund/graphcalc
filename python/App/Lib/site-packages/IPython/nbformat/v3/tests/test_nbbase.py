...
class TestCell(TestCase):
    ...
    def test_empty_raw_cell(self):
        ...
        self.assertEquals(tc.cell_type, 'raw')
        self.assertEquals('source' not in tc, True)
        self.assertEquals('rendered' not in tc, True)
    ...
    def test_empty_heading_cell(self):
        tc = new_heading_cell()
        self.assertEquals(tc.cell_type, 'heading')
        self.assertEquals('source' not in tc, True)
        self.assertEquals('rendered' not in tc, True)
