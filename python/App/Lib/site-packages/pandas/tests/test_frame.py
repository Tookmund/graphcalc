...
class TestDataFrame(unittest.TestCase, CheckIndexing,
    ...
    def test_astype(self):
        ...
        def _check_cast(df, v):
            self.assert_(list(set([ s.dtype.name for _, s in df.items() ]))[0] == v)
    ...
    def test_to_csv_moar(self):
        ...
        def _do_test(df,path,r_dtype=None,c_dtype=None,rnlvl=None,cnlvl=None,
               ...
               if cnlvl:
                   ...
                   cols=MultiIndex.from_tuples(list(map(stuple_to_tuple,recons.columns)))
                   recons.columns = cols
    ...
    def test_where(self):
        ...
        def _safe_add(df):
            ...
            return DataFrame(dict([ (c,s+1) if issubclass(s.dtype.type, (np.integer,np.floating)) else (c,s) for c, s in df.items() ]))
    ...
    def test_reset_index(self):
        ...
        for i, (lev, lab) in enumerate(list(zip(stacked.index.levels,
